    ...
    <div class="header-module">
      ...
      <div class="card-title">
        ...
        <div class="name-card2">
          Introduction to Module Details | Introduction to Reading
        </div>
      </div>
      ...
      <div v-if="selected1" class="columns is-gapless mb-0 pb-0">
        <div class="column is-narrow header-left">
          <div class="card-list">
            ...
            <img
              src="~/assets/images/module/thumbnail.png"
              class="display-pic"
            >
        ...
        <div class="column is-narrow header-right" style="margin-left: 20px">
          <div class="card-activity">
            <v-row style="width: 100%">
              <v-col md="6" class="title-chapter">
                Chapter 1 - Lorem ipsum
              </v-col>
              <v-col md="4" class="ml-auto">
                <v-btn class="btn-act" small>
                  Download Attachments
                </v-btn>
              </v-col>
            </v-row>
            <v-row class="mb-6 description-activity">
              ...
              Duis aute irure dolor in reprehenderit in voluptate. Duis aute
